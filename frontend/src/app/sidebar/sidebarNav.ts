...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  { tab: 'memory', icon: Brain, labelKey: 'sidebar.memory', zone: 'team' },
  { tab: 'journey', icon: Route, labelKey: 'sidebar.journey', zone: 'team' },
  ...
  { tab: 'performance', icon: Gauge, labelKey: 'sidebar.performance', zone: 'system' },
  { tab: 'files', icon: FolderTree, labelKey: 'sidebar.files', zone: 'system' },
  { tab: 'terminal', icon: SquareTerminal, labelKey: 'sidebar.terminal', zone: 'system' },
  { tab: 'voice', icon: AudioLines, labelKey: 'sidebar.voice', zone: 'system' },
  { tab: 'mcpserver', icon: ServerCog, labelKey: 'sidebar.mcpServer', zone: 'system' },
  { tab: 'theme', icon: Palette, labelKey: 'sidebar.theme', zone: 'system' },
