...
export default function WorkflowToolbar({ name, onName, replay, dirty, saving, canUndo, runBusy, savedAt, onAddNode, onUndo, onSave, onRun, onModal, runsOpen, onToggleRuns, onExitReplay }: {
  name: string;
