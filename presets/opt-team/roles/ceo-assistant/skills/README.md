...
|------|--------|------|------|--------------------------|
| `content-digestion` | 搭档丢过来一篇文章、一个链接、一段转 | v1.0 | 186 行 | `web_fetch web_search Read Write Edit memory_search memory_get` |
| `deep-research` | 面向个人学习的好奇心放大器——搭档对某个课题、产品、领域感兴趣，想系统了解但不为直接做商 | v1.0 | 201 行 | `web_search web_fetch Read Write Edit memory_search memory_get` |
